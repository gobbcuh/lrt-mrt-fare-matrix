// noob version: this project is the first version of the code & my very first programming project
#include <stdio.h>
        ...
        if (railwayLine == 1 && endStation == 16) // Transfer from LRT1 to LRT2 (D. Jose to Recto)
        {
            do
            {
                ...
                if (passengerChoice == 'Y' || passengerChoice == 'y')
                {
                    ...
                    // Show the "proceed to another station" prompt BEFORE the station list
                    ...
                    if (passengerChoice == 'Y' || passengerChoice == 'y')
                    {
                        // Display station list after confirmation
                ...
                {
                    printf("\n\tWould you like to proceed to another destination within LRT-1?\n\tY if YES\n\tN if NO\n");
                    printf("\tYour choice: ");
                    scanf(" %c", &passengerChoice);

                    if (passengerChoice == 'Y' || passengerChoice == 'y')
                    {
                        initialStation = endStation; // Proceed within the same line
                        break;
                    }
                    else
                    {
