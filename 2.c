...
int main() 
{
    ...
    do
    {
        ...
        do {
            printf("Your choice: ");
            if (scanf(" %c", &passengerChoice) != 1 || (passengerChoice != 'Y' && passengerChoice != 'y' && passengerChoice != 'N' && passengerChoice != 'n')) 
            {
