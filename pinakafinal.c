...
int main()
{
    ...
    do
    {
        if (railwayLine == 1 || railwayLine == 2 || railwayLine == 3)
        {
            printf("\n\tEnter your status: ");
            scanf("%s", input);
            sscanf(input, "%d", &passengerStatus);
    ...
    do
    {
        ...
        if (railwayLine == 1 || railwayLine == 2 || railwayLine == 3)
        {
            if (initialStation == endStation)
            {
                ...
                printf("\tYour choice: ");
                scanf("%s", input);
                sscanf(input, "%d", &passengerChoice);
