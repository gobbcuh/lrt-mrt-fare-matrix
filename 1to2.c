...
int main()
{
    ...
    char LRT2Stations[13][13] = {"Recto", "Legarda", "Pureza", "V. Mapa", "J. Ruiz", "Gilmore", "Betty Go", "Cubao", "Anonas", "Katipunan", "Santolan", "Marikina", "Antipolo"};
    ...
    printf("   Welcome to Railway Transportation Lines Fare Matrix\n----------------------------------------");
    ...
    scanf("%d", &passengerStatus);
        ...
        if (passengerStatus >= 1 && passengerStatus <= 4)
        {
            if (passengerStatus == 4)
            {
                printf("No discount will be applied\n");
            }
            else if (railwayLine == 1)
            {
            ...
            if (transferChoice == 'Y' || transferChoice == 'y')
            {
                ...
                do 
                {
                    ...
                    else if (passengerChoice == 'N' || passengerChoice == 'n')
                    {
                        printf("\nYour fare from %s to %s is: PHP %.2f", LRT1Stations[initialStation - 1], LRT1Stations[endStation - 1], currentFare);
                        printf("\nLast Station: Recto\n");
                        printf("\nThank you for using Railway Tranportation Lines Fare Matrix Calculator!");
                    }
                    else if (passengerChoice == 'Y' || passengerChoice == 'y')
                    {
                        printf("\nCard Types:\n1. Stored Value (Beep) Fare Card\n2. Single Journey Fare Card\n");
                        ...
                        initialStation = 1;
                        printf("\n\nYour current station is: %s", LRT2Stations); 
    ...
    printf("Your total fare for the entire trip is: PHP %.2f\nThank you for using Railway Transportation Lines Fare Matrix Calculator!\nHave a safe ride!\n", overallFare);
